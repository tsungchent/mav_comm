...
using AttitudeThrust = mav_msgs::msg::AttitudeThrust;
using Actuators = mav_msgs::msg::Actuators;
using RateThrust = mav_msgs::msg::RateThrust;
using TorqueThrust = mav_msgs::msg::TorqueThrust;
using RollPitchYawrateThrust = mav_msgs::msg::RollPitchYawrateThrust;
...
inline void eigenOdometryFromMsg(const nav_msgs::msg::Odometry& msg,
  ...
  odometry->timestamp_ns =  mav_msgs::toNSec(msg.header.stamp); // msg.header.stamp.toNSec();
...
inline void eigenTrajectoryPointFromMsg(
  ...
  if (msg.transforms.empty()) {
    RCLCPP_ERROR(rclcpp::get_logger(""), "MultiDofJointTrajectoryPoint is empty.");
    return;
  }
  ...
  trajectory_point->time_from_start_ns = toNSec(msg.time_from_start); // msg.time_from_start.toNSec();
...
inline void msgOdometryFromEigen(const EigenOdometry& odometry,
  ...
  if (odometry.timestamp_ns >= 0) {
    ...
    fromNSec(odometry.timestamp_ns, msg->header.stamp);
  }
...
inline void msgPoseStampedFromEigenTrajectoryPoint(
  ...
  if (trajectory_point.timestamp_ns >= 0) {
    ...
    fromNSec(trajectory_point.timestamp_ns, msg->header.stamp);
  }
...
inline void msgMultiDofJointTrajectoryPointFromEigen(
  ...
  fromNSec(trajectory_point.time_from_start_ns, msg->time_from_start);
...
inline void msgMultiDofJointTrajectoryFromEigen(
  ...
  if (trajectory.empty()) {
    RCLCPP_ERROR(rclcpp::get_logger(""), "EigenTrajectoryPointVector is empty.");
    return;
  }
